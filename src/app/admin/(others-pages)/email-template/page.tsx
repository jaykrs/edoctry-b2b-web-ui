...
function EmailTemplatePage() {
    ...
    // 🔹 form states (payload based)
    const [name, setName] = useState("");
    const [template, setTemplate] = useState(""); // description
    const [json, setJson] = useState("");
    const [htmlElement, setHtmlElement] = useState(""); // grapesjs later
    ...
    const handleSave = async () => {
        ...
        await fetch(url, {
            ...
            body: JSON.stringify({
                data: {
                    ...payload,
                    type: "email-templates", // 🔥 default, no UI
                },
            }),
        });
        ...
        <div className="min-h-screen">
            ...
            <div className="border-b bg-gradient-to-r from-indigo-100 via-purple-100 to-pink-100 px-6 py-3 shadow-sm">
                ...
                <TextHeading
                    ...
                    icon="📧"
                    savebuttonprops={{
                        buttonTitle: isEditMode ? "Update Template" : "Save Template",
                        icon: "✓",
                        onClick: handleSave,
                    }}
                    thirdbuttonprops={{
            ...
            <div className="h-[calc(100vh-80px)] overflow-y-auto">
                ...
                <div className="p-6 space-y-6 bg-white">
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            placeholder='{ "content": "Create personalized email templates..." }'
                        />
                    </div>
                </div>
                ...
                <EmailGrapesEditor
                    value={htmlElement}
                    onChange={(html) => setHtmlElement(html)}
                />
