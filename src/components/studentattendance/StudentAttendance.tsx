...
export default function StudentAttendance({ vendoruuid }: any) {
    ...
    return (
        <div className="w-full min-h-screen bg-gray-400/80 ">
            <div className="flex justify-center py-20 px-5">

                <div className="w-full sm:w-10/12 md:w-7/12 lg:w-5/12 flex mx-auto shadow rounded bg-gray-50 relative overflow-hidden">
                    <form className="mx-auto mt-3 p-10 pb-20 w-full relative z-10" onSubmit={handleSubmit}>
                    ...
                    {/* 🔥 Premium Floating Footer Logo */}
                    <div className="absolute bottom-0 left-0 w-full backdrop-blur-md bg-gray-200 border-t flex items-center justify-center py-2">
                        <img
                            src="https://edgeadmin.teqtoeducation.com/uploads/without_BG_2c5bf2036e.png"
                            alt="TEQTO EDGE"
                            className="h-8 "
                        />
                    </div>
