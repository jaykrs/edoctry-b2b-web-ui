    ...
    <div className="">
      <div className="border-b bg-gradient-to-r from-indigo-100 via-purple-100 to-pink-100 px-6 py-5 shadow-sm">
        <TextHeading
          ...
          buttonprops={{
            buttonText: "+",
            title: "Create Customer Email Template",
            content:
              "Create professional email templates to send important updates, offers, and notifications to your customers.",
                    ...
                    {options.map((opt, idx) => (
                      <TableRow key={idx}>
                        ...
                        <TableCell className="px-4 py-3 text-gray-500 text-theme-sm dark:text-gray-400">
                          <button
                            onClick={() =>
                              router.push(`/admin/email-template?pid=${opt.id}`)
                            }
