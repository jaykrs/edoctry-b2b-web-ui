...
//         doc.text(invoice.customeremail || "-", 120, 66);
...
//         doc.text(
//             `Total Amount: ${formatAmount(invoice.invoicetotal)}`,
//             rightX,
//             finalY + 18,
//             { align: "right" }
//         );
...
//                                                     <img
//                                                         src={`https://ui-avatars.com/api/?name=${encodeURIComponent(invoice.customername)}&background=random&color=fff`}
