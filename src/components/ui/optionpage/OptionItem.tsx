...
const OptionItem: React.FC<OptionItemProps> = ({ icon, name, author, pagepath, isSelected, onClick }) => {
  return (
    <div
      onClick={onClick}
      className={`flex w-full items-center justify-between p-4 rounded-xl shadow cursor-pointer transition-all duration-300 dark:text-gray-100 dark:bg-gray-800
