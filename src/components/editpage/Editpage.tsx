...
export default function EditPage() {
  ...
  const pageId = searchParams?.get("pid"); // ✅ safe in client
  ...
  return (
    <div className="createpage-container">
      ...
      <div className="step-content">
        {step === 1 && <DesignYourPage pageId={pageId} onNext={handleNext} onBack={handleBack} />}
        {step === 2 && <PreviewAndPublish onBack={handleBack} onNext={handleNext} data={{}} />}
        {step === 3 && <FinishPage />}
      </div>
    </div>
  );
