      ...
      {navItems.map((nav, index) => (
        <li key={nav.name}>
          {nav.subItems ? (
            <button
              onClick={() =>
                handleSubmenuToggle(index, menuType as "main" | "others")
              }
          ...
          {isExpanded || isHovered || isMobileOpen ? (
            <>
              <img
                ...
                src={
                  staff?.logo ||
                  "https://edgeadmin.teqtoeducation.com/uploads/without_BG_2c5bf2036e.png"
                }
